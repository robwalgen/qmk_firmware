 ...
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * |BackSP|   A  |   R  |   S  |   T  |   G  |-------.    ,-------|   M  |   N  |   E  |   I  |   O  |  DEL |
 * |------+------+------+------+------+------| MUTE  |    |   >   |------+------+------+------+------+------|
 ...
 */
 [_COLEMAK] = LAYOUT(
  ...
  KC_TAB,   KC_Q,   KC_W,    KC_F,    KC_P,    KC_B,                      KC_J,    KC_L,    KC_U,    KC_Y,    KC_MINS, KC_ESC,
  KC_BSPC,  KC_A,   KC_R,    KC_S,    KC_T,    KC_G,                      KC_M,    KC_N,    KC_E,    KC_I,    KC_O,    KC_DEL,
  KC_LSFT,  KC_Z,   KC_X,    KC_C,    KC_D,    KC_V, KC_MUTE, S(KC_NUBS), KC_K,    KC_H,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,
 ...
 * |-------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * |ralttab|  F11 |  F12 |      |      |      |                    |      |   7  |   8  |   9  |   0  |      |
 * |-------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * |   ^°  |      |   (  |   )  |   !  |      |-------.    ,-------|  ´ ` |   4  |   5  |   6  |  #'  |      |
 * |-------+------+------+------+------+------|   /   |    |   \   |------+------+------+------+------+------|
 * |LShift |   {  |   [  |   ]  |   }  |      |-------|    |-------|   +  |   1  |   2  |   3  |      |      |
 * `------------------------------------------/       /     \      \-----------------------------------------'
 *                    |NUMBER|LCTRL |LOWER | /Enter  /       \Space \  |ADJUST|   0  | RALT |
 *                    |      |      |      |/       /         \      \ |      |      |      |
 *                    `----------------------------'           '------''--------------------'
 */
 [_LOWER] = LAYOUT(
   KC_GRV,         KC_F1,      KC_F2,      KC_F3,      KC_F4,   KC_F5,                              KC_F6, KC_F7, KC_F8, KC_F9,  KC_F10, _______,
 RALT(KC_TAB),    KC_F11,     KC_F12,    _______,    _______, _______,                            _______,  KC_7,  KC_8,  KC_9,    KC_0, _______,
   KC_GRV,       _______,    S(KC_8),    S(KC_9),    S(KC_1), _______,                             KC_EQL,  KC_4,  KC_5,  KC_6, KC_NUHS, _______,
  KC_LSFT,    RALT(KC_7), RALT(KC_8), RALT(KC_9), RALT(KC_0), _______, S(KC_7),    RALT(KC_MINS), KC_RBRC,  KC_1,  KC_2,  KC_3, _______, _______,
                                   MO(_NUMBER), _______, _______, _______,                _______, MO(_ADJUST), KC_0, KC_COMM
),
/* NUMBER
 * ,-----------------------------------------.                     ,-----------------------------------------.
 * |   ^°  |  F1  |  F2  |  F3  |  F4  | F5   |                    |  F6  |  F7  |  F8  |  F9  | F10  |      |
 ...
 */
 ...
 RALT(KC_TAB), KC_F10,  KC_F12,  _______, _______, _______,                           _______,       KC_7,       KC_8, 	  KC_9, _______, _______,
  ...
  _______,    _______, _______,  _______, _______, _______, _______,      _______,    _______,       KC_1,       KC_2,    KC_3, KC_COMM, _______,
 ...
 */
 ...
 _______, RALT(KC_Q), S(KC_2), RALT(KC_E),       _______,       _______,                                   _______,    _______, KC_LBRC,    _______, _______, KC_PSCR,
  KC_CAPS,   KC_QUOT, _______, KC_MINS,          _______,       _______,                                RALT(KC_M), S(KC_MINS),   KC_UP, S(KC_BSLS), KC_SCLN, _______,
  _______,   S(KC_7), KC_NUBS, S(KC_NUBS), RALT(KC_MINS), RALT(KC_NUBS), RALT(KC_NUBS),     _______, RALT(KC_RBRC),    KC_LEFT, KC_DOWN,    KC_RGHT, _______, _______,
 ...
 */
  [_ADJUST] = LAYOUT(
  _______, DF(0),   DF(1),   DF(2),   _______, _______,                   _______, _______, _______, _______, _______, _______,
  _______, _______, _______, _______, _______, _______,                   _______, _______, _______, _______, _______, KC_PSCR,
  _______, _______, _______, _______, _______, KC_MPRV,                   KC_MNXT, KC_MPLY, _______, _______, _______, _______,
  _______, _______, _______, _______, _______, KC_VOLD, _______, _______, KC_VOLU, KC_MUTE, _______, _______, _______, _______,
                          _______, _______, _______, _______, _______, _______, _______, _______
)
};

// commented because it stopped the board from changing into _ADJUST //commented by robwalgen
/*
...
void render_default_layer_state(void) {
    ...
    switch (get_highest_layer(layer_state)) {
        case _COLEMAK:
            oled_write_ln_P(PSTR("CDHm"), false);
            break;
        case _QWERTY:
